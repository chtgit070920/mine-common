 ...
 *
 * copy from spring,,but i  made some improvements.
 */
public class MultiValueHashMap<K, V> implements MultiValueMap<K, V>, Serializable {
    ...
    /**
     * Create a new MultiValueHashMap that wraps a {@link LinkedHashMap}.
     */
    ...
    /**
     * Copy constructor: Create a new MultiValueHashMap with the same mappings
     * as the specified Map.
     * @param otherMap the Map whose mappings are to be placed in this Map
     */
    public MultiValueHashMap(Map<K, List<V>> otherMap) {
